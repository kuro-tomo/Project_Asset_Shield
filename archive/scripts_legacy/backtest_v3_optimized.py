...
class BacktesterV3Optimized:
    ...
    def __init__(self, cache_path: str, initial_capital: float = 10_000_000):
        ...
        # Strategy parameters (V3.2.0 PRODUCTION - Competition Ready)
        # Balanced configuration for consistent walk-forward performance
        self.max_positions = 20          # 20 positions for diversification
        ...
        self.pbr_pct = 0.20              # Bottom 20% (value)
        self.roe_pct = 0.80              # Top 20% (quality)
        self.composite_pct = 0.80        # Top 20% composite
        self.min_adt = 400_000_000       # 400M JPY ADT (World Rank compliant)
        self.stop_loss = -0.12           # 12% stop loss
        self.take_profit = 0.35          # 35% take profit
