...
class JapanStockData(PythonData):
    ...
    def Reader(self, config, line, date, isLiveMode):
        ...
        try:
            ...
            return None
class AssetShieldV32(QCAlgorithm):
    def Initialize(self):
        ...
        self.Debug("Asset Shield V3.2.0: " + str(len(self.tickers)) + " stocks")
    ...
    def Rebalance(self):
        ...
        self.Debug("REBAL " + str(self.Time.date()) + ": " + str(len(selected)) + " stocks")
    def OnEndOfAlgorithm(self):
        ret = (self.Portfolio.TotalPortfolioValue / 100000000 - 1) * 100
        self.Debug("Return: " + str(round(ret, 2)) + "%")
